...
class WordleClass:
    ...
    def get_word_difficulty_easy(self, player_turn):
        ...
        # check if there are any yellow tiles from previous guess
            ...
            while not generate_complete:
                ...
                # prevent guess to be the same as the previous guess
                if ai_guess == self.ai_grid[int((player_turn / 2) -1)][5][1:]:
                    break
                for letter in yellow_letters:
                    if letter in ai_guess:
                        yellow_matches += 1
                if yellow_matches == len(yellow_letters):
        ...
        # handle green and yellow tiles
            ...
            while not generate_complete:
                ...
                for letter in yellow_letters:
                    if letter in ai_guess:
                        yellow_matches += 1
                if green_matches == green_tiles and yellow_matches == len(yellow_letters):
                    generate_complete = True
